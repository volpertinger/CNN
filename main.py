...
if __name__ == '__main__':
    ...
    model = cnn.Model(cc.DATASET, img_proc, cc.CLASSES_NUMBER, cc.INPUT_SHAPE, cc.BATCH_SIZE, cc.EPOCHS,
                      ...
                      cc.KERNEL_INITIALIZER, cc.LEARNING_RATE, cc.MOMENTUM, cc.LOSS, cc.VALIDATION_SPLIT, cc.METRICS,
                      cc.SMALL_DOT, cc.LARGE_DOT, cc.SMALL_DENSE, cc.LARGE_DENSE, cc.SMALL_FILTER, cc.LARGE_FILTER,
                      cc.CMAP, cc.POSSIBILITY_PRECISION, cc.WITH_INFO, cc.WITH_PLOT, cc.VERBOSE)
    model.train()
